    ...
    configuration = [
        ...
        },
        {
            ...
            "keywords": ["panic", "fatal", "Error parsing XATTR", "zero", "protobuf.Error", "Encounter planner error",
                         ...
                         "Internal error while creating new scan request", "rollbackAllToZero", "Need older than last used snapshot",
                         "StorageMgr::handleCreateSnapshot Timestamp is not snapshot aligned"],
