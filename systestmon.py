    ...
    configuration = [
        {
            ...
            "services": "all",
            "keywords": ["exception occurred in runloop", "failover exited with reason", "Authorization.*Basic"],
        ...
        },
        {
            ...
            "services": "all",
            "keywords": ["CRITICAL", "Authorization.*Basic"],
            "ignore_keywords": None,
            "check_stats_api": False,
            "collect_dumps": False
        },
        {
            ...
            "keywords": ["panic", "fatal", "Error parsing XATTR", "zero", "protobuf.Error", "Encounter planner error",
                         "corruption", "processFlushAbort", "Authorization.*Basic"],
            "ignore_keywords": None,
        ...
        },
        {
            ...
            "keywords": ["fata", "Analytics Service is temporarily unavailable", "Failed during startup task", "HYR0",
                         "ASX", "IllegalStateException", "Authorization.*Basic"],
            "ignore_keywords": None,
            "check_stats_api": False,
            "collect_dumps": False
        },
        {
            ...
            "services": "eventing",
            "keywords": ["panic", "fatal", "Authorization.*Basic"],
            "ignore_keywords": None,
            "check_stats_api": False,
            "collect_dumps": False
        },
        {
            ...
            "logfiles": "fts.log*",
            "services": "fts",
            "keywords": ["panic", "fatal", "\[ERRO\]", "Authorization.*Basic"],
        ...
        },
        {
            ...
            "keywords": ["panic", "Error parsing XATTR", "Authorization.*Basic"],
            "ignore_keywords": None,
            "check_stats_api": False,
            "port": "9999",
            "collect_dumps": True
        },
        {
            ...
            "logfiles": "error.log*",
            "services": "all",
            "keywords": ["rebalance exited", "failover exited with reason", "Authorization.*Basic"],
            "ignore_keywords": None,
            "check_stats_api": False,
            "collect_dumps": False
        },
        {
            ...
            "logfiles": "info.log*",
            "services": "all",
            "keywords": ["exited with status", "failover exited with reason", "Authorization.*Basic"],
        ...
        },
        {
            ...
            "logfiles": "query.log*",
            "services": "n1ql",
            "keywords": ["panic", "fatal", "Encounter planner error", "Authorization.*Basic"],
            "ignore_keywords": None,
            "check_stats_api": False,
            "collect_dumps": True,
            "port": "8093"
